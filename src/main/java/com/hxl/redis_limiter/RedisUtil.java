...
public class RedisUtil {
    ...
    private final static Logger _logger = Logger.getLogger(RedisUtil.class);
    static {
    ...
    private RedisUtil() {
        if (pool == null) {
            String ip = prop.getProperty("redis.host");
            ...
            jedisPoolConfig.setMaxWaitMillis(Integer.parseInt(prop.getProperty("redis.maxWaitMillis")));
